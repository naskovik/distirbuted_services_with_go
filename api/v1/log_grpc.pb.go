...
func (x *logGetServersClient) Recv() (*GetServersResponse, error) {
	m := new(GetServersResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (x *logGetServersServer) Send(m *GetServersResponse) error {
	return x.ServerStream.SendMsg(m)
}
